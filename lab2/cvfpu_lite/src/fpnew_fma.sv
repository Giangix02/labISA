...
module fpnew_fma #(
  ...
  // Mantissa multiplier (a*b)
	//logic[2*PRECISION_BITS-1:0] produttazzoBastardo;
  //assign produttazzoBastardo = mantissa_a * mantissa_b;
  MantissaMultiplier mult(mantissa_a[PRECISION_BITS-1:0],mantissa_b[PRECISION_BITS-1:0],product[2*PRECISION_BITS-1:0]);
