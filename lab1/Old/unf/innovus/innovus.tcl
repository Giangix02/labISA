...
#  Created on Sat Oct 18 13:58:50 2025                
#                                                     
#######################################################
...
init_design
zoomBox 7.31300 25.68700 54.23550 67.50650
zoomBox -0.89900 13.87800 75.50700 81.97450
zoomBox -9.07250 2.12350 96.68000 96.37500
zoomBox -20.38600 -14.14550 125.98500 116.30700
getIoFlowFlag
setIoFlowFlag 0
floorPlan -coreMarginsBy die -site FreePDK45_38x28_10R_NP_162NW_34O -r 0.993837811191 0.699992 5 5 5 5
uiSetTool select
getIoFlowFlag
fit
...
selectWire 1.3650 1.3200 2.1650 108.1600 2 VSS
clearGlobalNets
...
place_design
zoomBox 12.41250 37.27800 72.36800 90.71300
zoomBox 17.90650 46.06000 61.22450 84.66700
zoomBox 12.41200 37.27750 72.36800 90.71300
zoomBox 4.80700 25.15500 87.79150 99.11450
zoomBox -0.02950 17.50250 97.59950 104.51400
gui_select -rect {33.24700 85.09200 36.48450 78.87650}
gui_select -rect {20.81700 96.74500 35.96650 79.39450}
deselectAll
deselectAll
selectInst mult0_mult_16_U11
gui_group_hinst
viewNext
gui_group_hinst
...
zoomBox -35.68900 -3.87700 88.72550 107.00700
zoomBox -78.41100 -38.13800 124.17800 142.41900
zoomBox -78.41150 -20.08250 124.17800 160.47450
zoomBox -78.41150 -2.02700 124.17800 178.53000
zoomBox -126.29500 -35.66950 154.10550 214.23650
fit
getFillerMode -quiet
addFiller -cell FILLCELL_X8 FILLCELL_X4 FILLCELL_X2 FILLCELL_X32 FILLCELL_X16 FILLCELL_X1 -prefix FILLER
saveDesign myfir0
selectInst FILLER__1_2951
reset_parasitics
extractRC
...
redirect -quiet {set honorDomain [getAnalysisMode -honorClockDomains]} > /dev/null
timeDesign -preCTS -hold -pathReports -slackReports -numPaths 50 -prefix myfir_preCTS -outDir timingReports
